...
std::string center(const string s, const int w) // sa 11
{
...
void sinhvien::hienthi()
{
	...
	cout << " | " << prd(tin1, 2, tcWidth) << " | " << prd(tin2, 2, tcWidth) << " | " << prd(tin3, 2, tcWidth) << " | " << prd(tin4, 2, tcWidth);
	cout << " | " << prd(anh1, 2, tcWidth) << " | " << prd(anh2, 2, tcWidth);
...
void khung(int[] arr, int width)
{
	...
	for (int i = 0; i < 7; i++)
	{
		cout << '+' << string(width + 2, separator);
	}
	cout << '+' << string(width + 6, separator) << '+';
}
...
void quanlysv::hienthi()
{
	...
	cout << " | " << center("Tin1", tcWidth) << " | " << center("Tin2", tcWidth) << " | " << center("Tin3", tcWidth) << " | " << center("Tin4", tcWidth);
	cout << " | " << center("Anh1", tcWidth) << " | " << center("Anh2", tcWidth) << " | " << center("DTB", tcWidth) << " | " << center("Xep Loai", 10) << " |\n";
